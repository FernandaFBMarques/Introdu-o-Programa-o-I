...
public class conversao {
    ...
    public static void diaSemanaFinal(int dia, int mes, int ano, double diaSemana){
        if(diaSemana == 0){
            System.out.println("Você nasceu no dia " + dia + " de " + mes + " de " + ano + ".Essa data foi uma segunda-feira");
        }else if(diaSemana == 1){
            System.out.println("Você nasceu no dia " + dia + " de " + mes + " de " + ano + ".Essa data foi uma terça-feira");
        }else if(diaSemana == 2){
            System.out.println("Você nasceu no dia " + dia + " de " + mes + " de " + ano + ".Essa data foi uma quarta-feira");
        }else if(diaSemana == 3){
            System.out.println("Você nasceu no dia " + dia + " de " + mes + " de " + ano + ".Essa data foi uma quinta-feira");
        }else if(diaSemana == 4){
            System.out.println("Você nasceu no dia " + dia + " de " + mes + " de " + ano + ".Essa data foi uma sexta-feira");
        }else if(diaSemana == 5){
            System.out.println("Você nasceu no dia " + dia + " de " + mes + " de " + ano + ".Essa data foi uma sábado");
        }else if(diaSemana == 6){
            System.out.println("Você nasceu no dia " + dia + " de " + mes + " de " + ano + ".Essa data foi uma domingo");
        }
    }
